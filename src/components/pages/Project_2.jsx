...
import photo_1 from "../../assets/carousel_p2/photo_1.png";
import photo_3 from "../../assets/carousel_p2/photo_3.png";
import photo_4 from "../../assets/carousel_p2/photo_4.png";
import photo_5 from "../../assets/carousel_p2/photo_5.png";

const IMAGES = [photo_1, photo_3, photo_4, photo_5];
        ...
        <div className="max-w-6xl mx-auto px-3">
          <div className="mb-6 p-6">
            ...
            <p className="text-md text-slate-650 max-w-56xl leading-relaxed">
              A backend API built to handle transactions safely under real-world
              conditions where clients retry failed requests, connections drop
              mid-operation, and abusive traffic needs to be stopped before reaching
              the database. It enforces idempotency with atomic SET NX so a
              retried payment never creates a duplicate, applies a token bucket rate
              limiter in Redis Lua for atomic enforcement across instances, and replays
              the original response when a client retries with the same key. Packaged with
              Docker Compose so the full stack runs with one command. The integration
              test suite spins up real containers rather than mocks, verifying rate
              limiting, idempotency, and race-condition safety.
            </p>
          </div>
          ...
          <div className="mb-8">
            <div className="carousel-wrapper">
              <div className="carousel-inner">
                ...
                <p className="carousel-subtitle">Explore the backend</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <RevealOnScroll>
              <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Create and manage transactions with account IDs, amounts, and
                  currencies. Every write is idempotent, so a retried request never
                  creates a duplicate record or charge.
                </p>
              </div>
            </RevealOnScroll>
            ...
            <RevealOnScroll>
              <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  A token bucket rate limiter runs atomically in Redis, enforcing a
                  configurable request capacity/client and returning 429 responses
                  with retry when the limit is exceeded.
                </p>
              </div>
            </RevealOnScroll>
            ...
            <RevealOnScroll>
              <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Retried requests with the same idempotency key receive the original
                  response, byte-for-byte. Concurrent duplicates are rejected with a
                  409 while the first request is still in flight.
                </p>
              </div>
            </RevealOnScroll>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
              <RevealOnScroll>
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 text-center">
                  ...
                  <p className="text-sm text-slate-600">
                    POST a transaction with an Idempotency-Key header. The API checks
                    the rate limiter before anything else runs.
                  </p>
                </div>
              </RevealOnScroll>
              ...
              <RevealOnScroll>
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 text-center">
                  ...
                  <p className="text-sm text-slate-600">
                    The API atomically claims the idempotency key in Redis using SET
                    NX. Only one request can hold a key at a time.
                  </p>
                </div>
              </RevealOnScroll>
              ...
              <RevealOnScroll>
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 text-center">
                  ...
                  <p className="text-sm text-slate-600">
                    New keys create and cache the response. Duplicate keys replay it,
                    or return 409 if the original is still processing.
                  </p>
                </div>
              </RevealOnScroll>
              ...
              <RevealOnScroll>
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 text-center">
                  ...
                  <p className="text-sm text-slate-600">
                    Integration tests spin up real Redis and Postgres containers to
                    verify rate limiting, replay behavior, and race-condition safety.
                  </p>
                </div>
              </RevealOnScroll>
            </div>
              ...
              <RevealOnScroll>
                <div className="flex items-start gap-2 bg-white p-3 rounded-xl border border-slate-200 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      The same request sent twice produces the same result. Atomic
                      SET NX claims prevent duplicate transactions even under
                      concurrent load.
                    </p>
                  </div>
                </div>
              ...
              <RevealOnScroll>
                <div className="flex items-start gap-2 bg-white p-3 rounded-xl border border-slate-200 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      Token bucket enforced atomically in Redis using Lua scripts.
                      Works across multiple API instances with no shared in-memory
                      state.
                    </p>
                  </div>
                </div>
              ...
              <RevealOnScroll>
                <div className="flex items-start gap-2 bg-white p-3 rounded-xl border border-slate-200 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      Retried requests receive the original status code, headers, and
                      body. Clients can safely retry without side effects.
                    </p>
                  </div>
                </div>
              </RevealOnScroll>
              ...
              <RevealOnScroll>
                <div className="flex items-start gap-2 bg-white p-3 rounded-xl border border-slate-200 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      Testcontainers spin up actual PostgreSQL and Redis instances,
                      verifying behavior that mocks cannot replicate.
                    </p>
                  </div>
                </div>
              </RevealOnScroll>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              href="https://github.com/esdrasj71/TransactionGateway.API"
              target="_blank"
